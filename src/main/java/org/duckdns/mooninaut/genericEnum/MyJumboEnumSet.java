...
final class MyJumboEnumSet<E extends MyEnum<E>> extends MyEnumSet<E> {
    /**
    ...
    MyJumboEnumSet(Class<E>elementType, MyEnum<?>[] universe) {
    ...
    private class EnumSetIterator<E extends MyEnum<E>> implements Iterator<E> {
        /**
    ...
    public boolean containsAll(Collection<?> c) {
        if (!(c instanceof MyJumboEnumSet<?> es))
    ...
    public boolean equals(Object o) {
        if (!(o instanceof MyJumboEnumSet<?> es))
    ...
    public MyEnumSet<E> clone() {
        MyJumboEnumSet<E> result = (MyJumboEnumSet<E>) super.clone();
