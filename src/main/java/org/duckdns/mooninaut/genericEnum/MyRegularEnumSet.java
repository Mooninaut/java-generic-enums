...
final class MyRegularEnumSet<E extends MyEnum<E>> extends MyEnumSet<E> {
    /**
    ...
    MyRegularEnumSet(Class<E>elementType, MyEnum<?>[] universe) {
    ...
    public boolean contains(Object e) {
        ...
        return (elements & (1L << ((MyEnum<?>)e).ordinal())) != 0;
    }
    ...
    public boolean containsAll(Collection<?> c) {
        if (!(c instanceof MyRegularEnumSet<?> es))
    ...
    public boolean equals(Object o) {
        if (!(o instanceof MyRegularEnumSet<?> es))
